...
Module DASK
	...
	Public Const PCI_7360 As Short = 49
    ...
    '------------------------'
    Public Const P7360_PortDIO As Short = 0
    Public Const P7360_PortAFI As Short = 1
	Public Const P7360_PortECLK As Short = 2
    'DIO Port
    Public Const P7360_DIO_A As Short = 0
    Public Const P7360_DIO_B As Short = 1
    Public Const P7360_DIO_C As Short = 2
    Public Const P7360_DIO_D As Short = 3
    'AFI Port
    Public Const P7360_AFI_0 As Short = 0
    Public Const P7360_AFI_1 As Short = 1
    Public Const P7360_AFI_2 As Short = 2
    Public Const P7360_AFI_3 As Short = 3
    Public Const P7360_AFI_4 As Short = 4
    Public Const P7360_AFI_5 As Short = 5
    Public Const P7360_AFI_6 As Short = 6
    Public Const P7360_AFI_7 As Short = 7
    'AFI Mode
    Public Const P7360_AFI_DIStartTrig As Short = 0
    Public Const P7360_AFI_DOStartTrig As Short = 1
    Public Const P7360_AFI_DIPauseTrig As Short = 2
    Public Const P7360_AFI_DOPauseTri As Short = 3
    Public Const P7360_AFI_DISWTrigOut As Short = 4
    Public Const P7360_AFI_DOSWTrigOut As Short =5
    Public Const P7360_AFI_COSTrigOut As Short = 6
    Public Const P7360_AFI_PMTrigOut As Short = 7
    Public Const P7360_AFI_HSDIREQ As Short = 8
    Public Const P7360_AFI_HSDIACK As Short = 9
    Public Const P7360_AFI_HSDITRIG As Short = 10
    Public Const P7360_AFI_HSDOREQ As Short = 11
    Public Const P7360_AFI_HSDOACK As Short = 12
    Public Const P7360_AFI_HSDOTRIG As Short = 13
    Public Const P7360_AFI_SPI As Short = 14
    Public Const P7360_AFI_I2C As Short = 15
    Public Const P7360_POLL_DI As Short = 16
    Public Const P7360_POLL_DO As Short = 17
    'Operation Mode
    Public Const P7360_FreeRun As Short = 0
    Public Const P7360_HandShake As Short = 1
    Public Const P7360_BurstHandShake As Short = 2
	Public Const P7360_BurstHandShake2 As Short = 3
    'Trigger Status
    Public Const P7360_WAIT_NO As Short = 0
    Public Const P7360_WAIT_EXTTRG As Short = 1
    Public Const P7360_WAIT_SOFTTRG As Short = 2
	Public Const P7360_WAIT_PATMATCH As Short = 3
    'Sampled Clock
    Public Const P7360_IntSampledCLK As Short = &H00S
    Public Const P7360_ExtSampledCLK As Short = &H01S
    'Sampled Clock Edge
    Public Const P7360_SampledCLK_R As Short = &H00S
    Public Const P7360_SampledCLK_F As Short = &H02S
    'Enable Export Sample Clock*/
    Public Const P7360_EnExpSampledCLK As Short = &H04S
    'Trigger Configuration
    Public Const P7360_EnPauseTrig As Short = &H01S
    Public Const P7360_EnSoftTrigOut As Short = &H02S
    'HandShake & Trigger Polarity
    Public Const P7360_DIREQ_POS As Short = &H00S
    Public Const P7360_DIREQ_NEG As Short = &H01S
    Public Const P7360_DIACK_POS As Short = &H00S
    Public Const P7360_DIACK_NEG As Short = &H02S
    Public Const P7360_DITRIG_POS As Short = &H00S
    Public Const P7360_DITRIG_NEG As Short = &H04S
    Public Const P7360_DIStartTrig_POS As Short = &H00S
    Public Const P7360_DIStartTrig_NEG As Short = &H08S
    Public Const P7360_DIPauseTrig_POS As Short = &H00S
    Public Const P7360_DIPauseTrig_NEG As Short = &H10S
    Public Const P7360_DOREQ_POS As Short = &H00S
    Public Const P7360_DOREQ_NEG As Short = &H01S
    Public Const P7360_DOACK_POS As Short = &H00S
    Public Const P7360_DOACK_NEG As Short = &H02S
    Public Const P7360_DOTRIG_POS As Short = &H00S
    Public Const P7360_DOTRIG_NEG As Short = &H04S
    Public Const P7360_DOStartTrig_POS As Short = &H00S
    Public Const P7360_DOStartTrig_NEG As Short = &H08S
    Public Const P7360_DOPauseTrig_POS As Short = &H00S
    Public Const P7360_DOPauseTrig_NEG As Short = &H10S
    'External Sampled Clock Source
    Public Const P7360_ECLK_IN As Short = 8
    'Export Sampled Clock
    Public Const P7360_ECLK_OUT As Short = 8
    'Enable Dynamic Delay Adjust
    Public Const P7360_DisDDA As Short = &H00S
    Public Const P7360_EnDDA As Short = &H01S
    'Dynamic Delay Adjust Mode
    Public Const P7360_DDA_Lag As Short = &H00S
    Public Const P7360_DDA_Lead As Short = &H02S
    'Enable Dynamic Phase Adjust
    Public Const P7360_DisDPA As Short = &H00S
    Public Const P7360_EnDPA As Short = &H01S
    'ECLK output type control
    Public Const P7360_ECLKAligned As Short = &H00S
    Public Const P7360_ECLKAlwaysOn As Short = &H01S
    ...
    Declare Function DI_7360_Config Lib "Pci-Dask.dll" (ByVal CardNumber As Short, ByVal DIPortWidth As Short, ByVal DIMode As Short, ByVal DIWaitStatus As Short, ByVal DIClkConfig As Short) As Short
    Declare Function DI_7360_TrigHSConfig Lib "Pci-Dask.dll" (ByVal CardNumber As Short, ByVal TrigConfig As Short, ByVal DI_IPOL As Short, ByVal DI_REQSrc As Short, ByVal DI_ACKSrc As Short, ByVal DI_TRIGSrc As Short, ByVal StartTrigSrc As Short, ByVal PauseTrigSrc As Short,  ByVal SoftTrigOutSrc As Short, ByVal SoftTrigOutLength As Integer, ByVal TrigCount As Integer) As Short
    Declare Function DI_7360_ExtSampCLKConfig Lib "Pci-Dask.dll" (ByVal CardNumber As Short, ByVal CLK_Src As Short, ByVal CLK_DDAMode As Short, ByVal CLK_DPAMode As Short, ByVal CLK_DDAVlaue As Short, ByVal CLK_DPAVlaue As Short) As Short
    Declare Function DI_7360_ExportSampCLKConfig Lib "Pci-Dask.dll" (ByVal CardNumber As Short, ByVal CLK_Src As Short, ByVal CLK_DPAMode As Short, ByVal CLK_DPAVlaue As Short) As Short
    Declare Function DI_7360_SoftTriggerGen Lib "Pci-Dask.dll" (ByVal CardNumber As Short) As Short
    Declare Function DI_7360_BurstHandShakeDelay Lib "Pci-Dask.dll" (ByVal CardNumber As Short, ByVal Delay As Byte) As Short
    ...
    Declare Function DO_7360_Config Lib "Pci-Dask.dll" (ByVal CardNumber As Short, ByVal DOPortWidth As Short, ByVal DOMode As Short, ByVal DOWaitStatus As Short, ByVal DOClkConfig As Short) As Short
    Declare Function DO_7360_TrigHSConfig Lib "Pci-Dask.dll" (ByVal CardNumber As Short, ByVal TrigConfig As Short, ByVal DO_IPOL As Short, ByVal DO_REQSrc As Short, ByVal DO_ACKSrc As Short, ByVal DO_TRIGSrc As Short, ByVal StartTrigSrc As Short, ByVal PauseTrigSrc As Short,  ByVal SoftTrigOutSrc As Short, ByVal SoftTrigOutLength As Integer, ByVal TrigCount As Integer) As Short
    Declare Function DO_7360_ExtSampCLKConfig Lib "Pci-Dask.dll" (ByVal CardNumber As Short, ByVal CLK_Src As Short, ByVal CLK_DDAMode As Short, ByVal CLK_DPAMode As Short, ByVal CLK_DDAVlaue As Short, ByVal CLK_DPAVlaue As Short) As Short
    Declare Function DO_7360_ExportSampCLKConfig Lib "Pci-Dask.dll" (ByVal CardNumber As Short, ByVal CLK_Src As Short, ByVal CLK_Mode As Short, ByVal CLK_DPAMode As Short, ByVal CLK_DPAVlaue As Short) As Short
    Declare Function DO_7360_SoftTriggerGen Lib "Pci-Dask.dll" (ByVal CardNumber As Short) As Short
    Declare Function DO_7360_BurstHandShakeDelay Lib "Pci-Dask.dll" (ByVal CardNumber As Short, ByVal Delay As Byte) As Short
	...
	Declare Function DIO_7360_AFIConfig Lib "Pci-Dask.dll" (ByVal CardNumber As Short, ByVal AFI_Port As Short, ByVal AFI_Enable As Short, ByVal AFI_Mode As Short, ByVal AFI_TrigOutLen As Integer) As Short
