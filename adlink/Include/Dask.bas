...
'
Global Const P7360_PortDIO = 0
Global Const P7360_PortAFI = 1
Global Const P7360_PortECLK = 2
'DIO Port
Global Const P7360_DIO_A = 0
Global Const P7360_DIO_B = 1
Global Const P7360_DIO_C = 2
Global Const P7360_DIO_D = 3
'AFI Por
Global Const P7360_AFI_0 = 0
Global Const P7360_AFI_1 = 1
Global Const P7360_AFI_2 = 2
Global Const P7360_AFI_3 = 3
Global Const P7360_AFI_4 = 4
Global Const P7360_AFI_5 = 5
Global Const P7360_AFI_6 = 6
Global Const P7360_AFI_7 = 7
'AFI Mode
Global Const P7360_AFI_DIStartTrig = 0
Global Const P7360_AFI_DOStartTrig = 1
Global Const P7360_AFI_DIPauseTrig = 2
Global Const P7360_AFI_DOPauseTrig = 3
Global Const P7360_AFI_DISWTrigOut = 4
Global Const P7360_AFI_DOSWTrigOut =5
Global Const P7360_AFI_COSTrigOut = 6
Global Const P7360_AFI_PMTrigOut = 7
Global Const P7360_AFI_HSDIREQ = 8
Global Const P7360_AFI_HSDIACK = 9
Global Const P7360_AFI_HSDITRIG = 10
Global Const P7360_AFI_HSDOREQ = 11
Global Const P7360_AFI_HSDOACK = 12
Global Const P7360_AFI_HSDOTRIG = 13
Global Const P7360_AFI_SPI = 14
Global Const P7360_AFI_I2C = 15
Global Const P7360_POLL_DI = 16
Global Const P7360_POLL_DO = 17
'Operation Mode
Global Const P7360_FreeRun = 0
Global Const P7360_HandShake = 1
Global Const P7360_BurstHandShake = 2
Global Const P7360_BurstHandShake2 = 3
'Trigger Status
Global Const P7360_WAIT_NO = 0
Global Const P7360_WAIT_EXTTRG = 1
Global Const P7360_WAIT_SOFTTRG = 2
Global Const P7360_WAIT_PATMATCH = 3
'Sampled Clock
Global Const P7360_IntSampledCLK = &H00
Global Const P7360_ExtSampledCLK = &H01
'Sampled Clock Edge
Global Const P7360_SampledCLK_R = &H00
Global Const P7360_SampledCLK_F = &H02
'Enable Export Sample Clock*/
Global Const P7360_EnExpSampledCLK = &H04
'Trigger Configuration
Global Const P7360_EnPauseTrig = &H01
Global Const P7360_EnSoftTrigOut = &H02
'HandShake & Trigger Polarity
Global Const P7360_DIREQ_POS = &H00
Global Const P7360_DIREQ_NEG = &H01
Global Const P7360_DIACK_POS = &H00
Global Const P7360_DIACK_NEG = &H02
Global Const P7360_DITRIG_POS = &H00
Global Const P7360_DITRIG_NEG = &H04
Global Const P7360_DIStartTrig_POS = &H00
Global Const P7360_DIStartTrig_NEG = &H08
Global Const P7360_DIPauseTrig_POS = &H00
Global Const P7360_DIPauseTrig_NEG = &H10
Global Const P7360_DOREQ_POS = &H00
Global Const P7360_DOREQ_NEG = &H01
Global Const P7360_DOACK_POS = &H00
Global Const P7360_DOACK_NEG = &H02
Global Const P7360_DOTRIG_POS = &H00
Global Const P7360_DOTRIG_NEG = &H04
Global Const P7360_DOStartTrig_POS = &H00
Global Const P7360_DOStartTrig_NEG = &H08
Global Const P7360_DOPauseTrig_POS = &H00
Global Const P7360_DOPauseTrig_NEG = &H10

'External Sampled Clock Source
Global Const P7360_ECLK_IN = 8
'Export Sampled Clock
Global Const P7360_ECLK_OUT = 8
'Enable Dynamic Delay Adjust
Global Const P7360_DisDDA = &H00
Global Const P7360_EnDDA = &H01
'Dynamic Delay Adjust Mode
Global Const P7360_DDA_Lag = &H00
Global Const P7360_DDA_Lead = &H02
'Enable Dynamic Phase Adjust
Global Const P7360_DisDPA = &H00
Global Const P7360_EnDPA = &H01
'ECLK output type control
Global Const P7360_ECLKAligned = &H00
Global Const P7360_ECLKAlwaysOn = &H01
...
Declare Function DI_7360_Config Lib "Pci-Dask.dll" (ByVal CardNumber As Integer, ByVal DIPortWidth As Integer, ByVal DIMode As Integer, ByVal DIWaitStatus As Integer, ByVal DIClkConfig As Integer) As Integer
Declare Function DI_7360_ExportSampCLKConfig Lib "Pci-Dask.dll" (ByVal CardNumber As Integer, ByVal CLK_Src As Integer, ByVal CLK_DPAMode As Integer, ByVal CLK_DPAVlaue As Integer) As Integer
Declare Function DI_7360_ExtSampCLKConfig Lib "Pci-Dask.dll" (ByVal CardNumber As Integer, ByVal CLK_Src As Integer, ByVal CLK_DDAMode As Integer, ByVal CLK_DPAMode As Integer, ByVal CLK_DDAVlaue As Integer, ByVal CLK_DPAVlaue As Integer) As Integer
Declare Function DI_7360_SoftTriggerGen Lib "Pci-Dask.dll" (ByVal CardNumber As Integer) As Integer
Declare Function DI_7360_TrigHSConfig Lib "Pci-Dask.dll" (ByVal CardNumber As Integer, ByVal TrigConfig As Integer, ByVal DI_IPOL As Integer, ByVal DI_REQSrc As Integer, ByVal DI_ACKSrc As Integer, ByVal DI_TRIGSrc As Integer, ByVal StartTrigSrc As Integer, ByVal PauseTrigSrc As Integer,  ByVal SoftTrigOutSrc As Integer, ByVal SoftTrigOutLength As Long, ByVal TrigCount As Long) As Integer
Declare Function DI_7360_BurstHandShakeDelay Lib "Pci-Dask.dll" (ByVal CardNumber As Integer, ByVal Delay As Byte) As Integer
...
Declare Function DO_7360_Config Lib "Pci-Dask.dll" (ByVal CardNumber As Integer, ByVal DOPortWidth As Integer, ByVal DOMode As Integer, ByVal DOWaitStatus As Integer, ByVal DOClkConfig As Integer) As Integer
Declare Function DO_7360_ExportSampCLKConfig Lib "Pci-Dask.dll" (ByVal CardNumber As Integer, ByVal CLK_Src As Integer, ByVal CLK_Mode As Integer, ByVal CLK_DPAMode As Integer, ByVal CLK_DPAVlaue As Integer) As Integer
Declare Function DO_7360_ExtSampCLKConfig Lib "Pci-Dask.dll" (ByVal CardNumber As Integer, ByVal CLK_Src As Integer, ByVal CLK_DDAMode As Integer, ByVal CLK_DPAMode As Integer, ByVal CLK_DDAVlaue As Integer, ByVal CLK_DPAVlaue As Integer) As Integer
Declare Function DO_7360_SoftTriggerGen Lib "Pci-Dask.dll" (ByVal CardNumber As Integer) As Integer
Declare Function DO_7360_TrigHSConfig Lib "Pci-Dask.dll" (ByVal CardNumber As Integer, ByVal TrigConfig As Integer, ByVal DO_IPOL As Integer, ByVal DO_REQSrc As Integer, ByVal DO_ACKSrc As Integer, ByVal DO_TRIGSrc As Integer, ByVal StartTrigSrc As Integer, ByVal PauseTrigSrc As Integer,  ByVal SoftTrigOutSrc As Integer, ByVal SoftTrigOutLength As Long, ByVal TrigCount As Long) As Integer
Declare Function DO_7360_BurstHandShakeDelay Lib "Pci-Dask.dll" (ByVal CardNumber As Integer, ByVal Delay As Byte) As Integer
...
Declare Function DIO_7360_AFIConfig Lib "Pci-Dask.dll" (ByVal CardNumber As Integer, ByVal AFI_Port As Integer, ByVal AFI_Enable As Integer, ByVal AFI_Mode As Integer, ByVal AFI_TrigOutLen As Long) As Integer
